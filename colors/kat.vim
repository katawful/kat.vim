...
call s:KatHiFun('Identifier', 'NONE', s:kat.bg[3], 'NONE', 'NONE')
call s:KatHiFun('Function', 'NONE', s:kat.bg[3], 'bold', 'NONE')

call s:KatHiFun('Statement', 'NONE', s:kat.fg[2], 'NONE', 'NONE')
call s:KatHiFun('Conditional', 'NONE', s:kat.blue[0], 'bold', 'NONE')
...
call s:KatHiFun('Type', 'NONE', s:kat.purple[2], 'bold', 'NONE')
